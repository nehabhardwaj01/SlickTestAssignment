...
object Hello extends App {
  ...
  /*
   * Drop all the exixsting tables.
   * Use these statements one after another.
   */
//  EmployeeComponent.drop
//  Thread.sleep(1000)

//  DependentComponent.drop
//  Thread.sleep(5000)

//  ProjectComponent.drop
//  Thread.sleep(1000)


  /*
   * Create all the databases.
   *  Use these statements one after another to reflect changes for foreign key.
   */
